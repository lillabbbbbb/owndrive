        ...
        <Table className="w-auto mx-auto">
          ...
          <TableBody>
            {(currentRows || []).map((file) => (
              ...
              <TableRow className={clsx(THEME.table.row(lightMode), THEME.table.hover(lightMode), "text-left w-auto whitespace-nowrap px-4 py-2")} key={file._id} onClick={() => handleRowSingleClick(file)} onDoubleClick={() => handleRowDoubleClick(file)} onPointerUp={() => handlePointerUp(file)}>
