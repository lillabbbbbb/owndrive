...
export function EditableText({value, onSave, className, validate = () => true,
  errorMessage = "Invalid file name",}: EditableTextProps) {
  ...
  return (
    <>
      ...
      <Input
        ...
        className={`h-7 px-1 transition-colors duration-100 ${
          isValid ? "" : "border border-red-500 outline-none"
        } ${className}`}
      />
       {!isValid && (
