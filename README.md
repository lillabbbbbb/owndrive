...
|   |   |   ├── ui/   #Shadcn's locally stored components
|   |   |   ├── main_components/   
|   |   |   ├── popups/
|   |   |   └── ...        #Other components
│   │   ├── hooks/         # Hooks for user and file
...
│   ├── middleware/    # User validation, multer config
│   ├── models/        # MongoDB models
│   ├── routes/        # API routes
│   ├── scripts/   # DB-related scripts (seed, droptable)
│   ├── types/   # 
...
- **File Explorer View**: Dashboard view options for browsing files
- **Search Bar**: Real-time search functionality across all files
...
#### 4. Searching, Sorting and Filtering (Frontend)
